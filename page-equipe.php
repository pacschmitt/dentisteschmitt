...
<main id="primary" class="site-main container section-padding">
    ...
    <section class="team-grid">
        ...
        <div class="cards-grid">
            <!-- Docteurs -->
            <div class="card">
                <div style="background:#EAE6DF; height:250px; margin-bottom:20px; border-radius:8px; display:flex; align-items:center; justify-content:center; color:#999;">Photo</div>
